    ...
    function getHTMLVersion()
    {
        ...
        if (!isset($htmlVersionMap)) {
            $htmlVersionMap = array(
                                    ...
                                    'eggy|P751v' => '3.2',
                                    '505i|252i|900i|506i|880i|253i|P213i|901i|700i|851i|701i|881i|^SA800i$|600i|^L601i$|^M702i(S|G)$|^L602i$|' => '5.0',
                                    '902i|702i|851i|882i|^N601i$|^D800iDS$|^P703imyu$|^P704imyu$|^L704i$|^F883i$' => '6.0',
                                    '903i|703i|904i|704i|883i|801i' => '7.0',
                                    '905i' => '7.1'
                                    );
        }
